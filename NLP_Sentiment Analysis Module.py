# -*- coding: utf-8 -*-
"""NLP_Sentiment Analysis Module.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yBqCcHUKGhjnoCT1phEOub544SZ4IKm3
"""
...
short_pos = open("/content/positive.txt", "r", encoding = 'ISO-8859-1').read()
short_neg = open("/content/negative.txt", "r", encoding = 'ISO-8859-1').read()
...
save_all_words = open("/content/all_words.pickle", "wb")
...
save_word_features = open("/content/word_features.pickle", "wb")
...
save_classifier = open("/content/naivebayes.pickle", "wb")
...
print("Orignial Naive Bayes Algo accuracy percent:", (nltk.classify.accuracy(classifier, testing_set))*100)
...
print(sentiment("the movie was bad"))
print(sentiment("the move was good, really awesome, great"))